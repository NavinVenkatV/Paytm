        ...
        <div className="h-full flex flex-col justify-center">
            ...
            >
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <h3 class="text-2xl font-semibold">To {name}</h3>
                </div>
                <div class="space-y-4">
                    <div class="space-y-2">
                    <label
                    ...
                    }} class="justify-center rounded-md text-sm font-medium ring-offset-background transition-colors h-10 px-4 py-2 w-full bg-black hover:bg-yellow-400 text-white">
                        Initiate Transfer
                    </button>
                </div>
                </div>
